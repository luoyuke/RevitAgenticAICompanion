...
- Copies the packaged payload into `%LOCALAPPDATA%\RevitAgenticAICompanion\install\current`.
...
```text
%LOCALAPPDATA%\RevitAgenticAICompanion\install\current
```
...
<RevitAddIns>
  <AddIn Type="Application">
    ...
    <Assembly>%LOCALAPPDATA%\RevitAgenticAICompanion\install\current\RevitAgenticAICompanion.Addin.dll</Assembly>
...
3. Delete `%LOCALAPPDATA%\RevitAgenticAICompanion\install\current`.
